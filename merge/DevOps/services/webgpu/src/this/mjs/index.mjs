// import wasmFreeQueue from './free-queue/src/wasm/free-queue.js'
import FreeQueue from './free-queue/src/free-queue.js'
...
export {
    ...
    FRAME_SIZE,
    QUEUE_SIZE
} from './free-queue/src/constants.js'

export { FreeQueue }
// export { FreeQueue, wasmFreeQueue }
