...
int CLine::Initialize(void* params)
{
	...
	std::cout << "int CLine::Initialize(void* params)" << std::endl;
	return 1;
	
}

void CLine::Terminate()
{
...
void CLine::core_line(double in) {
...
l_count_in  CLine::count(l_count_in in){
...
int CLine::zero_sample_count(int zero, double in){
...
int CLine::true_peack(int phase_num){
