...
export function getDocumentRect() {
    ...
    const height = Math.max(body.scrollHeight, body.offsetHeight, clientHeight, html.scrollHeight, html.offsetHeight);
    const width = Math.max(body.scrollWidth, body.offsetWidth, clientWidth, html.scrollWidth, html.offsetWidth);
    return {
        height,
        width,
        clientWidth,
 ...
 */
export function getRelativePosition(element, relativePos) {
 ...
 */
export function getPositionByPlacement(placement, domRect) {
...
export function getAttr(domElement, attr) {
 ...
 * @returns
 */
export function getDataAttributionsFromProps(props) {
