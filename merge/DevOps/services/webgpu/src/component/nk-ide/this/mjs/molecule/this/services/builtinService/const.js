...
export const modules = {
    ...
    builtInExplorerFolderPanel: () => ({
        ...
        toolbar: [
            ...
            },
            {
                ...
                title: localize('sidebar.explore.collapseFolders', 'Collapse Folders in Explorer'),
                icon: 'collapse-all',
            },
        ],
        config: {
    ...
    builtInExplorerHeaderToolbar: () => ({
        ...
        title: localize(constants.EXPLORER_ACTION_TITLE, 'View and More Actions...'),
        icon: 'ellipsis',
        contextMenu: [],
    }),
        ...
        toolbar: [
            {
                ...
                title: localize(constants.EXPLORER_TOGGLE_VERTICAL, 'Toggle Vertical'),
                icon: 'editor-layout',
            },
            {
            ...
            },
            {
                ...
                title: localize(constants.EXPLORER_TOGGLE_CLOSE_ALL_EDITORS, 'Close All Editors'),
                icon: 'close-all',
            },
        ],
        groupToolbar: [
            ...
            },
            {
                ...
                title: localize(constants.EXPLORER_TOGGLE_CLOSE_GROUP_EDITORS, 'Close Group Editors'),
                icon: 'close-all',
            },
        ],
        config: {
    ...
    builtInSearchAddons: () => [
        {
            ...
            title: localize(constants.SEARCH_CASE_SENSITIVE_COMMAND_ID, 'Match Case'),
            disabled: false,
            checked: false,
            icon: 'case-sensitive',
        },
        {
            ...
            title: localize(constants.SEARCH_WHOLE_WORD_COMMAND_ID, 'Match Whole Word'),
            disabled: false,
            checked: false,
            icon: 'whole-word',
        },
        {
            ...
            disabled: false,
            checked: false,
            title: localize(constants.SEARCH_REGULAR_EXPRESSION_COMMAND_ID, 'Use Regular Expression'),
            icon: 'regex',
        },
    ],
    builtInReplaceAddons: () => [
        {
            ...
            title: localize(constants.SEARCH_PRESERVE_CASE_COMMAND_ID, 'Preserve Case'),
            disabled: false,
            checked: false,
            icon: 'preserve-case',
        },
    ...
    builtInPanelToolboxReStore: () => ({
        id: constants.PANEL_TOOLBOX_RESIZE,
        title: localize(constants.PANEL_TOOLBOX_RESTORE_SIZE, 'Restore Panel Siz'),
        icon: 'chevron-down',
    }),
    builtInPanelToolbox: () => ({
                ...
                },
                {
                    ...
                    data: [
                        ...
                        },
                        {
                            ...
                            name: localize('menu.menuBarHorizontal', 'Menu Bar Horizontal Mode'),
                        },
                        {
                            id: constants.MENUBAR_MODE_VERTICAL,
                            name: localize('menu.menuBarVertical', 'Menu Bar Vertical Mode'),
                        },
                    ],
                },
            ],
    ...
    FOLDER_PANEL_CONTEXT_MENU: () => [
        {
            id: constants.NEW_FOLDER_COMMAND_ID,
            name: localize('contextmenu.addFolderToSpace', 'Add Folder to Workspace...'),
        },
        {
