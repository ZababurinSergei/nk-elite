...
export const splitDraggingClassName = getBEMModifier(splitClassName, 'dragging');
...
export const sashVerticalClassName = getBEMModifier(sashItemClassName, 'vertical');
export const sashHorizontalClassName = getBEMModifier(sashItemClassName, 'horizontal');
export const sashDisabledClassName = getBEMModifier(sashItemClassName, 'disabled');
