...
import { ID_ACTIVITY_BAR, ID_SIDE_BAR, ID_EXPLORER, ID_FOLDER_TREE, ID_EDITOR_TREE, } from './../../../../this/common/id';
...
const editorTreeFileNameClassName = getBEMElement(editorTreeItemClassName, 'fileName');
const editorTreeFilePathClassName = getBEMElement(editorTreeItemClassName, 'filePath');
const editorTreeActiveItemClassName = getBEMModifier(editorTreeItemClassName, 'active');
const editorTreeCloseIconClassName = getBEMElement(editorTreeClassName, 'close');
