import { ProxySqlite3 } from "./main-thread/sqlite3.js";
...
export default async (options = {
    ...
    const result = await request(worker, {
        func: "initialize",
        wasmLocation: new URL("./wasm/sqlite3.wasm",import.meta.url).href, asyncProxyLocation: new URL("./wasm/sqlite3-opfs-async-proxy.js", import.meta.url).href,
    })
