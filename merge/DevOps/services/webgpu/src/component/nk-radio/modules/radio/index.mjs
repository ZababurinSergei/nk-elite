...
const ctx = async (CONFIG) => {
    if(!CONFIG.audio.ctx) {
        ...
        await CONFIG.audio.ctx.audioWorklet.addModule(new URL('../../../../this/mjs/free-queue/src/radio-processor.mjs', import.meta.url).pathname);
    }
    ...
    if(isEmpty(worker)) {
        worker = new Worker(new URL('../../../../this/mjs/free-queue/src/worker.sync.js', import.meta.url), {
            name: 'Radio',
            type: 'module',
        });
    }
