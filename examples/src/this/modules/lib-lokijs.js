  ...
  "node_modules/joi/dist/joi-browser.min.js"(exports, module) {
    !function(e, t) {
      ...
      return e = { 7629: (e2, t2, r) => {
        ...
        t2.provider = { provision: /* @__PURE__ */ __name((e3) => new i.Cache(e3), "provision") }, i.Cache = class {
          constructor(e3 = {}) {
        ...
        p.methods = { ValidationError: l.ValidationError, version: i.version, cache: a.provider, assert(e3, t3, ...r2) {
          ...
          return t3;
        }, isError: l.ValidationError.isError, isExpression: m.isTemplate, isRef: f.isRef, isSchema: i.isSchema, in: /* @__PURE__ */ __name((...e3) => f.in(...e3), "in"), override: i.symbols.override, ref: /* @__PURE__ */ __name((...e3) => f.create(...e3), "ref"), types() {
          const e3 = {};
        ...
        }, u.constants = { true: true, false: false, null: null, second: 1e3, minute: 6e4, hour: 36e5, day: 864e5 }, u.functions = { if: /* @__PURE__ */ __name((e3, t3, r2) => e3 ? t3 : r2, "if"), length: /* @__PURE__ */ __name((e3) => "string" == typeof e3 ? e3.length : e3 && "object" == typeof e3 ? Array.isArray(e3) ? e3.length : Object.keys(e3).length : null, "length"), msg(e3) {
        ...
        e2.exports = a.extend({ type: "alternatives", flags: { match: { default: "any" } }, terms: { matches: { init: [], register: c.toSibling } }, args: /* @__PURE__ */ __name((e3, ...t3) => 1 === t3.length && Array.isArray(t3[0]) ? e3.try(...t3[0]) : e3.try(...t3), "args"), validate(e3, t3) {
          ...
          if (r2._flags.match) {
            ...
            const c2 = /* @__PURE__ */ __name((e4) => e4.$_terms.matches.some((e5) => "object" === e5.schema.type || "alternatives" === e5.schema.type && c2(e5.schema)), "c");
          ...
          return this.$_parent("label", e3).$_modify({ each: /* @__PURE__ */ __name((t3, r2) => "is" !== r2.path[0] && "string" != typeof t3._flags.label ? t3.label(e3) : void 0, "each"), ref: false });
        } }, rebuild(e3) {
        ...
        }, validate: /* @__PURE__ */ __name((e3, t3, { limit: r2 }, { name: s2, operator: n2, args: a2 }) => o.compare(e3.length, r2, n2) ? e3 : t3.error("array." + s2, { limit: a2.limit, value: e3 }), "validate"), args: [{ name: "limit", ref: true, assert: o.limit, message: "must be a positive integer" }] }, max: { method(e3) {
        ...
        "use strict";
        const s = r(375), n = r(8068), a = r(8160), i = r(2036), o = { isBool: /* @__PURE__ */ __name(function(e3) {
        ...
        } } }, cast: { number: { from: o.isBool, to: /* @__PURE__ */ __name((e3, t3) => e3 ? 1 : 0, "to") }, string: { from: o.isBool, to: /* @__PURE__ */ __name((e3, t3) => e3 ? "true" : "false", "to") } }, manifest: { build: /* @__PURE__ */ __name((e3, t3) => (t3.truthy && (e3 = e3.truthy(...t3.truthy)), t3.falsy && (e3 = e3.falsy(...t3.falsy)), e3), "build") }, messages: { "boolean.base": "{{#label}} must be a boolean" } });
      }, 7500: (e2, t2, r) => {
        "use strict";
        const s = r(375), n = r(8068), a = r(8160), i = r(3328), o = { isDate: /* @__PURE__ */ __name(function(e3) {
          return e3 instanceof Date;
        }, "isDate") };
        e2.exports = n.extend({ type: "date", coerce: { from: ["number", "string"], method: /* @__PURE__ */ __name((e3, { schema: t3 }) => ({ value: o.parse(e3, t3._flags.format) || e3 }), "method") }, validate(e3, { schema: t3, error: r2, prefs: s2 }) {
        ...
        }, args: [{ name: "date", ref: true, normalize: /* @__PURE__ */ __name((e3) => "now" === e3 ? e3 : o.parse(e3), "normalize"), assert: /* @__PURE__ */ __name((e3) => null !== e3, "assert"), message: "must have a valid date format" }] }, format: { method(e3) {
        ...
        e2.exports = o.extend({ type: "_keys", properties: { typeof: "object" }, flags: { unknown: { default: void 0 } }, terms: { dependencies: { init: null }, keys: { init: null, manifest: { mapped: { from: "schema", to: "key" } } }, patterns: { init: null }, renames: { init: null } }, args: /* @__PURE__ */ __name((e3, t3) => e3.keys(t3), "args"), validate(e3, { schema: t3, error: r2, state: s2, prefs: n2 }) {
        ...
        }, rules: { compare: { method: false, validate: /* @__PURE__ */ __name((e3, t3, { limit: r2 }, { name: s2, operator: n2, args: i2 }) => a.compare(e3, r2, n2) ? e3 : t3.error("number." + s2, { limit: i2.limit, value: e3 }), "validate"), args: [{ name: "limit", ref: true, assert: a.isNumber, message: "must be a number" }] }, greater: { method(e3) {
        ...
        }, validate: /* @__PURE__ */ __name((e3, t3, { base: r2, baseDecimalPlace: s2, pfactor: n2 }, a2) => i.decimalPlaces(e3) > s2 ? t3.error("number.multiple", { multiple: a2.args.base, value: e3 }) : Math.round(n2 * e3) % Math.round(n2 * r2) == 0 ? e3 : t3.error("number.multiple", { multiple: a2.args.base, value: e3 }), "validate"), args: [{ name: "base", ref: true, assert: /* @__PURE__ */ __name((e3) => "number" == typeof e3 && isFinite(e3) && e3 > 0, "assert"), message: "must be a positive number" }, "baseDecimalPlace", "pfactor"], multi: true }, negative: { method() {
        ...
        }, validate: /* @__PURE__ */ __name((e3, t3, { sign: r2 }) => "negative" === r2 && e3 < 0 || "positive" === r2 && e3 > 0 ? e3 : t3.error(`number.${r2}`), "validate") }, unsafe: { method(e3 = true) {
        ...
        }, validate: /* @__PURE__ */ __name((e3, t3, { options: r2 }) => m.base64Regex[r2.paddingRequired][r2.urlSafe].test(e3) ? e3 : t3.error("string.base64"), "validate") }, case: { method(e3) {
          return s(["lower", "upper"].includes(e3), "Invalid case:", e3), this.$_addRule({ name: "case", args: { direction: e3 } });
        }, validate: /* @__PURE__ */ __name((e3, t3, { direction: r2 }) => "lower" === r2 && e3 === e3.toLocaleLowerCase() || "upper" === r2 && e3 === e3.toLocaleUpperCase() ? e3 : t3.error(`string.${r2}case`), "validate"), convert: true }, creditCard: { method() {
        ...
        }, validate: /* @__PURE__ */ __name((e3, t3, r2, { address: s2 }) => n.isValid(e3, s2) ? e3 : t3.error("string.domain"), "validate") }, email: { method(e3 = {}) {
        ...
        }, validate: /* @__PURE__ */ __name((e3, t3, { options: r2 }) => ("optional" === r2.prefix ? m.hexRegex.withOptionalPrefix : true === r2.prefix ? m.hexRegex.withPrefix : m.hexRegex.withoutPrefix).test(e3) ? r2.byteAligned && e3.length % 2 != 0 ? t3.error("string.hexAlign") : e3 : t3.error("string.hex"), "validate") }, hostname: { method() {
          return this.$_addRule("hostname");
        }, validate: /* @__PURE__ */ __name((e3, t3) => n.isValid(e3, { minDomainSegments: 1 }) || m.ipRegex.test(e3) ? e3 : t3.error("string.hostname"), "validate") }, insensitive: { method() {
        ...
        }, validate: /* @__PURE__ */ __name((e3, { error: t3 }) => m.isoDate(e3) ? e3 : t3("string.isoDate"), "validate") }, isoDuration: { method() {
          return this.$_addRule("isoDuration");
        }, validate: /* @__PURE__ */ __name((e3, t3) => m.isoDurationRegex.test(e3) ? e3 : t3.error("string.isoDuration"), "validate") }, length: { method(e3, t3) {
        ...
        t2.entry = function(e3, t3, r2) {
          ...
          if (a2.externals.length) {
            ...
            for (const n3 of a2.externals) {
              ...
              try {
                const e4 = /* @__PURE__ */ __name((e5, t5) => (m || n3.schema).$_createError(e5, p, t5, n3.state, s2), "e"), i2 = await n3.method(p, { schema: n3.schema, linked: m, state: n3.state, prefs: r2, original: y, error: e4, errorsArray: u.errorsArray, warn: /* @__PURE__ */ __name((e5, t5) => a2.warnings.push((m || n3.schema).$_createError(e5, p, t5, n3.state, s2)), "warn"), message: /* @__PURE__ */ __name((e5, t5) => (m || n3.schema).$_createError("external", p, t5, n3.state, s2, { messages: e5 }), "message") });
  ...
  "node_modules/lokijs/src/loki-indexed-adapter.js"(exports, module) {
    (function(root, factory) {
      ...
      return function() {
        ...
        __name(LokiIndexedAdapter, "LokiIndexedAdapter");
        ...
        LokiIndexedAdapter.prototype.saveDatabase = function(dbname, dbstring, callback) {
          ...
          __name(saveCallback, "saveCallback");
          if (this.catalog === null || this.catalog.db === null) {
            this.catalog = new LokiCatalog(function(cat) {
        ...
        __name(LokiCatalog, "LokiCatalog");
  ...
  "node_modules/lokijs/src/lokijs.js"(exports, module) {
    (function(root, factory) {
      ...
      return function() {
        ...
        var Utils = {
          copyProperties: /* @__PURE__ */ __name(function(src, dest) {
            var prop;
            for (prop in src) {
              dest[prop] = src[prop];
            }
          ...
          resolveTransformObject: /* @__PURE__ */ __name(function(subObj, params, depth) {
            var prop, pname;
            ...
            return subObj;
          }, "resolveTransformObject"),
          // top level utility to resolve an entire (single) transform (array of steps) for parameter substitution
          resolveTransformParams: /* @__PURE__ */ __name(function(transform, params) {
          ...
          // getIn({a: {b: 1}}, "a.b", true) => 1
          getIn: /* @__PURE__ */ __name(function(object, path, usingDotNotation) {
            if (object == null) {
              return void 0;
            }
            if (!usingDotNotation) {
        ...
        __name(compoundeval, "compoundeval");
        ...
        __name(containsCheckFn, "containsCheckFn");
        ...
        __name(doQueryOp, "doQueryOp");
        var LokiOps = {
          // comparison operators
          // a is the value in the collection
          // b is the query value
          $eq: /* @__PURE__ */ __name(function(a, b) {
            return a === b;
          }, "$eq"),
          // abstract/loose equality
          $aeq: /* @__PURE__ */ __name(function(a, b) {
            return a == b;
          }, "$aeq"),
          $ne: /* @__PURE__ */ __name(function(a, b) {
            if (b !== b) {
              return a === a;
            }
            return a !== b;
          ...
          $dteq: /* @__PURE__ */ __name(function(a, b) {
            return Comparators.aeq(a, b);
          }, "$dteq"),
          // loki comparisons: return identical unindexed results as indexed comparisons
          $gt: /* @__PURE__ */ __name(function(a, b) {
            return Comparators.gt(a, b, false);
          }, "$gt"),
          $gte: /* @__PURE__ */ __name(function(a, b) {
            return Comparators.gt(a, b, true);
          }, "$gte"),
          $lt: /* @__PURE__ */ __name(function(a, b) {
            return Comparators.lt(a, b, false);
          }, "$lt"),
          $lte: /* @__PURE__ */ __name(function(a, b) {
            return Comparators.lt(a, b, true);
          }, "$lte"),
          // lightweight javascript comparisons
          $jgt: /* @__PURE__ */ __name(function(a, b) {
            return a > b;
          }, "$jgt"),
          $jgte: /* @__PURE__ */ __name(function(a, b) {
            return a >= b;
          }, "$jgte"),
          $jlt: /* @__PURE__ */ __name(function(a, b) {
            return a < b;
          }, "$jlt"),
          $jlte: /* @__PURE__ */ __name(function(a, b) {
            return a <= b;
          }, "$jlte"),
          // ex : coll.find({'orderCount': {$between: [10, 50]}});
          $between: /* @__PURE__ */ __name(function(a, vals) {
            if (a === void 0 || a === null) return false;
            return Comparators.gt(a, vals[0], true) && Comparators.lt(a, vals[1], true);
          }, "$between"),
          $jbetween: /* @__PURE__ */ __name(function(a, vals) {
            if (a === void 0 || a === null) return false;
            return a >= vals[0] && a <= vals[1];
          }, "$jbetween"),
          $in: /* @__PURE__ */ __name(function(a, b) {
            return b.indexOf(a) !== -1;
          }, "$in"),
          $inSet: /* @__PURE__ */ __name(function(a, b) {
            return b.has(a);
          }, "$inSet"),
          $nin: /* @__PURE__ */ __name(function(a, b) {
            return b.indexOf(a) === -1;
          }, "$nin"),
          $keyin: /* @__PURE__ */ __name(function(a, b) {
            return a in b;
          }, "$keyin"),
          $nkeyin: /* @__PURE__ */ __name(function(a, b) {
            return !(a in b);
          }, "$nkeyin"),
          $definedin: /* @__PURE__ */ __name(function(a, b) {
            return b[a] !== void 0;
          }, "$definedin"),
          $undefinedin: /* @__PURE__ */ __name(function(a, b) {
            return b[a] === void 0;
          }, "$undefinedin"),
          $regex: /* @__PURE__ */ __name(function(a, b) {
            return b.test(a);
          }, "$regex"),
          $containsString: /* @__PURE__ */ __name(function(a, b) {
            return typeof a === "string" && a.indexOf(b) !== -1;
          }, "$containsString"),
          $containsNone: /* @__PURE__ */ __name(function(a, b) {
            return !LokiOps.$containsAny(a, b);
          }, "$containsNone"),
          $containsAny: /* @__PURE__ */ __name(function(a, b) {
          ...
          $contains: /* @__PURE__ */ __name(function(a, b) {
            var checkFn = containsCheckFn(a);
            if (checkFn !== null) {
          ...
          $elemMatch: /* @__PURE__ */ __name(function(a, b) {
            if (Array.isArray(a)) {
          ...
          $type: /* @__PURE__ */ __name(function(a, b, record) {
            var type = typeof a;
            if (type === "object") {
              if (Array.isArray(a)) {
                type = "array";
          ...
          $finite: /* @__PURE__ */ __name(function(a, b) {
            return b === isFinite(a);
          }, "$finite"),
          $size: /* @__PURE__ */ __name(function(a, b, record) {
            if (Array.isArray(a)) {
              return typeof b !== "object" ? a.length === b : doQueryOp(a.length, b, record);
            }
            return false;
          }, "$size"),
          $len: /* @__PURE__ */ __name(function(a, b, record) {
            if (typeof a === "string") {
              return typeof b !== "object" ? a.length === b : doQueryOp(a.length, b, record);
            }
            return false;
          }, "$len"),
          $where: /* @__PURE__ */ __name(function(a, b) {
            return b(a) === true;
          }, "$where"),
          ...
          $not: /* @__PURE__ */ __name(function(a, b, record) {
            return !doQueryOp(a, b, record);
          }, "$not"),
          $and: /* @__PURE__ */ __name(function(a, b, record) {
          ...
          $or: /* @__PURE__ */ __name(function(a, b, record) {
            for (var idx = 0, len = b.length; idx < len; idx += 1) {
              if (doQueryOp(a, b[idx], record)) {
                return true;
              }
          ...
          $exists: /* @__PURE__ */ __name(function(a, b) {
            if (b) {
              return a !== void 0;
            } else {
              return a === void 0;
        ...
        __name(cloneObjectArray, "cloneObjectArray");
        ...
        __name(LokiEventEmitter, "LokiEventEmitter");
        ...
        function Loki(filename, options) {
          ...
          var getENV = /* @__PURE__ */ __name(function() {
            if (typeof window !== "undefined" && (window.android || window.NSObject)) {
              return "NATIVESCRIPT";
            }
            if (typeof window === "undefined") {
              return "NODEJS";
            }
            if (typeof window !== "undefined" && window.window && typeof process !== "undefined") {
              return "NODEJS";
            }
        ...
        Loki.prototype.generateChangesNotification = function(arrayOfCollectionNames) {
          ...
          __name(getCollName, "getCollName");
        ...
        __name(LokiMemoryAdapter, "LokiMemoryAdapter");
        ...
        __name(LokiPartitioningAdapter, "LokiPartitioningAdapter");
        ...
        LokiPartitioningAdapter.prototype.loadNextPartition = function(partition, callback) {
          ...
          this.adapter.loadDatabase(keyname, function(result) {
            var data = self2.dbref.deserializeCollection(result, { delimited: true, collectionIndex: partition });
        ...
        LokiPartitioningAdapter.prototype.saveNextPage = function(callback) {
          ...
          var pageSaveCallback = /* @__PURE__ */ __name(function(err) {
            pageBuilder = "";
            if (err) {
              callback(err);
            }
        ...
        __name(LokiFsAdapter, "LokiFsAdapter");
        LokiFsAdapter.prototype.loadDatabase = /* @__PURE__ */ __name(function loadDatabase(dbname, callback) {
          var self2 = this;
          this.fs.stat(dbname, function(err, stats) {
            if (!err && stats.isFile()) {
              self2.fs.readFile(dbname, {
                encoding: "utf8"
              }, /* @__PURE__ */ __name(function readFileCallback(err2, data) {
                if (err2) {
        ...
        LokiFsAdapter.prototype.saveDatabase = /* @__PURE__ */ __name(function saveDatabase(dbname, dbstring, callback) {
          var self2 = this;
          var tmpdbname = dbname + "~";
          this.fs.writeFile(tmpdbname, dbstring, /* @__PURE__ */ __name(function writeFileCallback(err) {
            if (err) {
        ...
        LokiFsAdapter.prototype.deleteDatabase = /* @__PURE__ */ __name(function deleteDatabase(dbname, callback) {
          this.fs.unlink(dbname, /* @__PURE__ */ __name(function deleteDatabaseCallback(err) {
            if (err) {
              callback(new Error(err));
            } else {
              callback();
        ...
        __name(LokiLocalStorageAdapter, "LokiLocalStorageAdapter");
        LokiLocalStorageAdapter.prototype.loadDatabase = /* @__PURE__ */ __name(function loadDatabase(dbname, callback) {
        ...
        LokiLocalStorageAdapter.prototype.saveDatabase = /* @__PURE__ */ __name(function saveDatabase(dbname, dbstring, callback) {
          if (localStorageAvailable()) {
        ...
        LokiLocalStorageAdapter.prototype.deleteDatabase = /* @__PURE__ */ __name(function deleteDatabase(dbname, callback) {
          if (localStorageAvailable()) {
        ...
        Loki.prototype.loadDatabaseInternal = function(options, callback) {
          ...
          if (this.persistenceAdapter !== null) {
            this.persistenceAdapter.loadDatabase(this.filename, /* @__PURE__ */ __name(function loadDatabaseCallback(dbString) {
        ...
        Loki.prototype.saveDatabaseInternal = function(callback) {
          ...
          if (this.persistenceAdapter.mode === "incremental") {
            ...
            this.persistenceAdapter.saveDatabase(
              this.filename,
              /* @__PURE__ */ __name(function getLokiCopy() {
              ...
              /* @__PURE__ */ __name(function exportDatabaseCallback(err) {
                self2.ignoreAutosave = false;
                if (err && cachedDirty) {
                ...
                cFun(err);
              }, "exportDatabaseCallback")
            );
          } else if (this.persistenceAdapter.mode === "reference" && typeof this.persistenceAdapter.exportDatabase === "function") {
            this.persistenceAdapter.exportDatabase(this.filename, this.copy({ removeNonSerializable: true }), /* @__PURE__ */ __name(function exportDatabaseCallback(err) {
              self2.autosaveClearFlags();
              cFun(err);
            }, "exportDatabaseCallback"));
          } else {
            this.autosaveClearFlags();
            this.persistenceAdapter.saveDatabase(this.filename, this.serialize(), /* @__PURE__ */ __name(function saveDatabasecallback(err) {
              cFun(err);
            }, "saveDatabasecallback"));
          }
        };
        ...
        Loki.prototype.deleteDatabase = function(options, callback) {
          ...
          if (this.persistenceAdapter !== null) {
            this.persistenceAdapter.deleteDatabase(this.filename, /* @__PURE__ */ __name(function deleteDatabaseCallback(err) {
              cFun(err);
            }, "deleteDatabaseCallback"));
          } else {
            cFun(new Error("persistenceAdapter not configured"));
        ...
        Loki.prototype.autosaveEnable = function(options, callback) {
          ...
          this.autosaveHandle = setInterval(/* @__PURE__ */ __name(function autosaveHandleInterval() {
            if (self2.autosaveDirty() && !self2.ignoreAutosave) {
              self2.saveDatabase(callback);
            }
          }, "autosaveHandleInterval"), delay);
        };
        ...
        __name(precompileQuery, "precompileQuery");
        ...
        Resultset.prototype.eqJoin = function(joinData, leftJoinKey, rightJoinKey, mapFun, dataOptions) {
          ...
          if (!mapFun) {
            mapFun = /* @__PURE__ */ __name(function(left, right) {
              return {
                left,
                right
              };
        ...
        __name(DynamicView, "DynamicView");
        ...
        DynamicView.prototype.removeDocument = function(objIndex) {
          ...
          var filt = /* @__PURE__ */ __name(function(idx2) {
            return function(di) {
        ...
        function Collection(name, options) {
          ...
          function observerCallback(changes) {
            ...
            changedObjects.forEach(function(object) {
              if (!hasOwnProperty.call(object, "$loki"))
                return self2.removeAutoUpdateObserver(object);
              try {
                self2.update(object);
              } catch (err) {
              }
          ...
          __name(getChangeDelta, "getChangeDelta");
          ...
          __name(getObjectDelta, "getObjectDelta");
          ...
          this.on("delete", /* @__PURE__ */ __name(function deleteCallback(obj) {
        ...
        Collection.prototype.ttlDaemonFuncGen = function() {
          ...
          return /* @__PURE__ */ __name(function ttlDaemon() {
            var now = Date.now();
            var toRemove = collection.chain().where(/* @__PURE__ */ __name(function daemonFilter(member) {
        ...
        __name(isDeepProperty, "isDeepProperty");
        function parseBase10(num) {
          return parseFloat(num, 10);
        }
        __name(parseBase10, "parseBase10");
        ...
        __name(standardDeviation, "standardDeviation");
        ...
        __name(deepProperty, "deepProperty");
        ...
        KeyValueStore.prototype = {
          keys: [],
          values: [],
          sort: /* @__PURE__ */ __name(function(a, b) {
            return a < b ? -1 : a > b ? 1 : 0;
          }, "sort"),
          setSort: /* @__PURE__ */ __name(function(fun) {
            this.bs = new BSonSort(fun);
          }, "setSort"),
          bs: /* @__PURE__ */ __name(function() {
        ...
        __name(ExactIndex, "ExactIndex");
        ExactIndex.prototype = {
          set: /* @__PURE__ */ __name(function add2(key, val) {
            if (this.index[key]) {
          ...
          remove: /* @__PURE__ */ __name(function remove(key, val) {
          ...
          clear: /* @__PURE__ */ __name(function clear(key) {
            this.index = {};
          }, "clear")
        };
        ...
        SortedIndex.prototype = {
          ...
          // get all values which have a key < the given key
          getLt: /* @__PURE__ */ __name(function(key) {
            var bsr = binarySearch(this.keys, key, this.sort);
            var pos = bsr.index;
            if (bsr.found) pos--;
          ...
          // get all values which have a key > the given key
          getGt: /* @__PURE__ */ __name(function(key) {
            var bsr = binarySearch(this.keys, key, this.sort);
            var pos = bsr.index;
            if (bsr.found) pos++;
          ...
          getAll: /* @__PURE__ */ __name(function(key, start, end) {
            var results = [];
          ...
          getPos: /* @__PURE__ */ __name(function(key) {
            return binarySearch(this.keys, key, this.sort);
          }, "getPos"),
          // remove the value from the index, if the value was the last one, remove the key
          remove: /* @__PURE__ */ __name(function(key, value) {
...
// modules/dep-lokijs.js
var Joi = __toESM(require_joi_browser_min(), 1);
var lokijs = __toESM(require_lokijs(), 1);
...
var Stream = /* @__PURE__ */ function() {
  ...
  _proto.on = /* @__PURE__ */ __name(function on(type, listener) {
    if (!this.listeners[type]) {
      this.listeners[type] = [];
    }
    this.listeners[type].push(listener);
  }, "on");
  _proto.off = /* @__PURE__ */ __name(function off(type, listener) {
    if (!this.listeners[type]) {
      return false;
    }
  ...
  _proto.trigger = /* @__PURE__ */ __name(function trigger(type) {
  ...
  _proto.dispose = /* @__PURE__ */ __name(function dispose() {
    this.listeners = {};
  }, "dispose");
  _proto.pipe = /* @__PURE__ */ __name(function pipe(destination) {
...
var atob = /* @__PURE__ */ __name(function atob2(s) {
...
__name(decodeB64ToUint8Array, "decodeB64ToUint8Array");
...
var parseByterange = /* @__PURE__ */ __name(function(byterangeString) {
...
var attributeSeparator = /* @__PURE__ */ __name(function() {
  const key = "[^=]*";
  const value = '"[^"]*"|[^,]*';
  const keyvalue = "(?:" + key + ")=(?:" + value + ")";
  return new RegExp("(?:^|,)(" + keyvalue + ")");
}, "attributeSeparator");
var parseAttributes = /* @__PURE__ */ __name(function(attributes) {
  const result = {};
  if (!attributes) {
    return result;
  }
...
var parseResolution = /* @__PURE__ */ __name((resolution) => {
...
var ParseStream = class extends Stream {
  ...
  addParser({
    ...
    if (typeof dataParser !== "function") {
      dataParser = /* @__PURE__ */ __name((line) => line, "dataParser");
    }
  ...
  addTagMapper({
    ...
    const mapFn = /* @__PURE__ */ __name((line) => {
...
var camelCase = /* @__PURE__ */ __name((str) => str.toLowerCase().replace(/-(\w)/g, (a) => a[1].toUpperCase()), "camelCase");
var camelCaseKeys = /* @__PURE__ */ __name(function(attributes) {
  const result = {};
...
var setHoldBack = /* @__PURE__ */ __name(function(manifest) {
  const {
    serverControl,
    targetDuration,
    partTargetDuration
        ...
        tag() {
          ({
            ...
            define() {
              ...
              const addDef = /* @__PURE__ */ __name((n, v) => {
...
*/
//# sourceMappingURL=lib-lokijs.js.map
