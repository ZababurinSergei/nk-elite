...
var COLOR_SPACES = {
  [LinearSRGBColorSpace]: {
    ...
    toReference: /* @__PURE__ */ __name((color) => color, "toReference"),
    fromReference: /* @__PURE__ */ __name((color) => color, "fromReference")
  },
  [SRGBColorSpace]: {
    transfer: SRGBTransfer,
    primaries: Rec709Primaries,
    luminanceCoefficients: [0.2126, 0.7152, 0.0722],
    toReference: /* @__PURE__ */ __name((color) => color.convertSRGBToLinear(), "toReference"),
    fromReference: /* @__PURE__ */ __name((color) => color.convertLinearToSRGB(), "fromReference")
  },
  [LinearDisplayP3ColorSpace]: {
    transfer: LinearTransfer,
    primaries: P3Primaries,
    luminanceCoefficients: [0.2289, 0.6917, 0.0793],
    toReference: /* @__PURE__ */ __name((color) => color.applyMatrix3(LINEAR_DISPLAY_P3_TO_LINEAR_SRGB), "toReference"),
    fromReference: /* @__PURE__ */ __name((color) => color.applyMatrix3(LINEAR_SRGB_TO_LINEAR_DISPLAY_P3), "fromReference")
  },
  [DisplayP3ColorSpace]: {
    transfer: SRGBTransfer,
    primaries: P3Primaries,
    luminanceCoefficients: [0.2289, 0.6917, 0.0793],
    toReference: /* @__PURE__ */ __name((color) => color.convertSRGBToLinear().applyMatrix3(LINEAR_DISPLAY_P3_TO_LINEAR_SRGB), "toReference"),
    fromReference: /* @__PURE__ */ __name((color) => color.applyMatrix3(LINEAR_SRGB_TO_LINEAR_DISPLAY_P3).convertLinearToSRGB(), "fromReference")
  }
};
...
var ColorManagement = {
  ...
  getLuminanceCoefficients: /* @__PURE__ */ __name(function(target, colorSpace = this._workingColorSpace) {
...
three/build/three.module.js:
   ...
   *)
*/
//# sourceMappingURL=lib-solar-system-orbit-controls.js.map
