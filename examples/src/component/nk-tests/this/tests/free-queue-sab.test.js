...
describe('FreeQueueSAB', function () {
    ...
    describe('Constructor', function () {
        it.skip('should initialize states correctly', function () {
            expect(queue.states).to.be.an.instanceof(Uint32Array);
            expect(queue.states.length).to.equal(2);
        });

        it.skip('should initialize buffer length correctly', function () {
            expect(queue.getBufferLength()).to.equal(bufferLength);
        });
    });

    describe('Channel Adaption', () => {
        it.skip('should initialize channel data correctly', function () {
        ...
        it.skip('should not adapt to an invalid channel count (e.g., negative or zero)', function () {
    ...
    describe('push', function () {
        it.skip('should push data into the queue', function () {
        ...
        it.skip('should fail to push data when buffer is full', function () {
        ...
        it.skip('should handle maximum capacity', function () {
    ...
    describe('pull', function () {
        it.skip('should pull data from the queue', function () {
            const input = [new Float32Array([1, 2, 3]), new Float32Array([4, 5, 6])];
            queue.push(input, 3);
        ...
        it.skip('should fail to pull data when buffer is empty', function () {
    ...
    describe('Utility Methods', function () {
        it.skip('should correctly get available samples', function () {
        ...
        it.skip('should correctly check if frame is available', function () {
    ...
    describe('Error Handling', () => {
        it.skip('should throw an error when push input length does not match channel count', function () {
        ...
        it.skip('should return false when pushing with insufficient available write space', function () {
        ...
        it.skip('should return false when pulling with insufficient available read space', function () {
            const bufferLength = 4; 
            const channelCount = 2;
            const queue = new FreeQueueSAB(bufferLength, channelCount);
    ...
    describe('Performance Tests', function () {
        it.skip('should handle large data efficiently', function () {
        ...
        it.skip('should handle small data efficiently', function () {
