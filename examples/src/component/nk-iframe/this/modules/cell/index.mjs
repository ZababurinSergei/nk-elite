import { loader } from '@newkind/this'
export const cell = async function () {
    let obj = this
    ...
    const urlJason = new URL('./cell-modules/jason.mjs', import.meta.url)
    const urlSt = new URL('./cell-modules/st.mjs', import.meta.url)
    // const urlDragula = new URL('./cell-modules/dragula.js', import.meta.url)
    await loader(urlJason.pathname)
    await loader(urlSt.pathname)
    // await loader(urlDragula.pathname)
    let ST = window.ST
    let Jason = window.Jason
    // let dragula = window.dragula

    // let Jason = await loader('./cell-modules/jason.mjs')
    // let ST = await loader('./cell-modules/st.mjs')
    // let dragula = await loader('./cell-modules/dragula.min.js')
    window.location.search

    // console.log('dddddddddddddddddddddd', window.location.origin)
    // debugger
    let url = {}
