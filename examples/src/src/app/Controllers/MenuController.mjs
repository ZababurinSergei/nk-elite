...
import {moonMenuControllerInit} from './MoonMenuController.mjs'
export const menuControllerInit = function () {
  const TravelController = travelControllerInit.call(this)
  const MoonMenuController = moonMenuControllerInit.call(this)
  ...
  return Backbone.View.extend({
    ...
    initialize: function(options) {
      ...
      this.template = this.templateLoader.get('planets', 'app/Views/menu.twig').then((template)=> {
