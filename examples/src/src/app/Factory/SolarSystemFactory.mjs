...
import {effectsControllerInit} from '../Controllers/EffectsController.mjs'
export const systemFactory = async function () {
  ...
  const RenderController = renderControllerInit.call(this)
  ...
  const EffectsController = effectsControllerInit.call(this)
  /**
   * SolarSystemFactory
   *
   * @param {Object} data
  ...
  SolarSystemFactory.prototype.build = function(data) {
    return new Promise((resolve)=> {
      ...
      console.log('ddddddddd SET SUN ddddddddd', sun)
  ...
  SolarSystemFactory.prototype.initializeUserInterface = function(currentTarget) {
    ...
    // console.log('vvvvvvvvvvvvvvvvvvvv', self.shadowRoot.querySelector('#social-buttons-corner'))
    // debugger
